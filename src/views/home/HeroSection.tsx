...
export default function HeroSection() {
  return (
    <section id="home" className='h-screen relative flex justify-center items-center overflow-hidden flex-col'>
        ...
        <h1 className="text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl my-6 font-bold tracking-wide text-transparent bg-clip-text bg-linear-to-r from-red-700 to-gray-300">Hi, I&apos;m Khoa Tran</h1>
    </section>
  )
}
